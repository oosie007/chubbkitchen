! function(t) {
    ...
    t.fn.redactor = function(i) {
        ...
        formattingAdd: !1,
        buttons: ["code", "format", "bold", "italic", "deleted", "lists", "image", "file", "link"],
        buttonsHide: [],
        buttonsHideOnMobile: [],
        script: !0,
        removeNewlines: !1,
        ...
        loadOptions: function(e) {
            var i = {};
            "undefined" != typeof t.Redactor.settings.namespace ? this.$element.hasClass(t.Redactor.settings.namespace) && (i = t.Redactor.settings) : i = t.Redactor.settings, this.opts = t.extend({}, t.Redactor.opts, this.$element.data(), e), this.opts = t.extend(!0, this.opts, i)
        },
        ...
        bindModuleMethods: function(t) {
            if ("undefined" != typeof this[t]) {
                this[t] = this[t]();
                for (var e = this.getModuleMethods(this[t]), i = e.length, o = 0; i > o; o++) this[t][e[o]] = this[t][e[o]].bind(this)
            }
        },
        air: function() {
            return {
                ...
                bindHide: function() {
                    t(document).on("mousedown.redactor-air." + this.uuid, t.proxy(function(e) {
                        ...
                        if ((this.utils.isRedactorParent(e.target) || t(e.target).hasClass("redactor-in")) && 0 === t(e.target).closest("#redactor-modal").length) {
                            if (i === this.keyCode.ESC) this.selection.get().collapseToStart();
                            else if (i === this.keyCode.BACKSPACE || i === this.keyCode.DELETE) {
                                var o = this.selection.get(),
                                    r = this.selection.range(o);
                                r.deleteContents()
                            } else i === this.keyCode.ENTER && this.selection.get().collapseToEnd();
                            this.air.enabled ? this.air.hide(e) : this.selection.get().collapseToStart()
                        }
                    }, this))
                },
                hide: function(e) {
                    var i = e.ctrlKey || e.metaKey || e.shiftKey && e.altKey;
                    return i ? !1 : (this.button.setInactiveAll(), this.$air.fadeOut(100), this.air.enabled = !1, t(document).off("mousedown.redactor-air." + this.uuid), void t(document).off("keydown.redactor-air." + this.uuid))
                }
            }
        },
        autosave: function() {
            return {
                ...
                success: function(t) {
                    ...
                    var o = "undefined" == typeof e.error ? "autosave" : "autosaveError";
                    this.core.callback(o, this.autosave.name, e), this.autosave.html = this.autosave.source
                },
                disable: function() {
        ...
        block: function() {
            return {
                ...
                formatCollapsed: function(e, i, o, r) {
                    ...
                    if (-1 === t.inArray(n, this.block.tags)) return void this.selection.restore();
                    n === e && (e = "p");
                    var a;
                    if ("blockquote" === n && this.utils.isEndOfElement(s)) {
                        this.marker.remove(), a = document.createElement("p"), a.innerHTML = this.opts.invisibleSpace, t(s).after(a), this.caret.start(a);
                        var l = t(s).children().last();
                        0 !== l.length && "BR" === l[0].tagName && l.remove()
                    } else a = this.utils.replaceToTag(s, e);
                    if ("object" == typeof i) {
                        r = o;
                        for (var c in i) a = this.block.setAttr(a, c, i[c], r)
                ...
                formatUncollapsed: function(e, i, o, r) {
                    this.selection.save();
                    var s = [],
                        n = this.selection.blocks();
                    n[0] && t(n[0]).hasClass("redactor-in") && (n = t(n[0]).find(this.opts.blockTags.join(", ")));
                    for (var a = n.length, l = 0; a > l; l++) {
                        var c = n[l].tagName.toLowerCase();
                        if (-1 !== t.inArray(c, this.block.tags) && "figure" !== c) {
                            var d = this.utils.replaceToTag(n[l], e);
                            if ("object" == typeof i) {
                                r = o;
                                for (var h in i) d = this.block.setAttr(d, h, i[h], r)
                ...
                removeAllAttr: function(e) {
                    ...
                    return t.each(e, function(e, o) {
                        ...
                        for (var r = t(o), s = o.attributes.length, n = 0; s > n; n++) r.removeAttr(o.attributes[n].name);
                        i.push(r[0])
                    }), i
                }
            }
        ...
        buffer: function() {
            return {
                ...
                setUndo: function() {
                    var t = this.selection.saveInstant(),
                        e = this.opts.buffer[this.opts.buffer.length - 1],
                        i = this.core.editor().html(),
                        o = "undefined" == typeof e || e[0] !== i;
                ...
                undo: function() {
                    if (0 !== this.opts.buffer.length) {
                        var t = this.opts.buffer.pop();
                        this.buffer.set("redo"), this.core.editor().html(t[0]), this.selection.restoreInstant(t[1])
                    }
                },
                redo: function() {
                    if (0 !== this.opts.rebuffer.length) {
                        var t = this.opts.rebuffer.pop();
                        this.buffer.set("undo"), this.core.editor().html(t[0]), this.selection.restoreInstant(t[1])
                    }
                },
                clear: function() {
                    this.opts.rebuffer = []
        ...
        build: function() {
            return {
                start: function() {
                    if ("inline" === this.opts.type) this.opts.type = "inline";
                    else if ("div" === this.opts.type) {
                        var e = t.trim(this.$editor.html());
                        "" === e && this.$editor.html(this.opts.emptyHtml)
                    } else "textarea" === this.opts.type && this.build.startTextarea();
                ...
                setOptions: function() {
                    "inline" === this.opts.type && (this.opts.enterKey = !1), "inline" !== this.opts.type && "pre" !== this.opts.type || (this.opts.toolbarMobile = !1, this.opts.toolbar = !1, this.opts.air = !1, this.opts.linkify = !1), this.core.editor().attr("spellcheck", this.opts.spellcheck), this.opts.structure && this.core.editor().addClass("redactor-structure"), "textarea" === this.opts.type && (this.core.box().attr("dir", this.opts.direction), this.core.editor().attr("dir", this.opts.direction), this.opts.tabindex && this.core.editor().attr("tabindex", this.opts.tabindex), this.opts.minHeight ? this.core.editor().css("min-height", this.opts.minHeight) : this.core.editor().css("min-height", "40px"), this.opts.maxHeight && this.core.editor().css("max-height", this.opts.maxHeight), this.opts.maxWidth && this.core.editor().css({
                ...
                plugins: function() {
                    this.opts.plugins && t.each(this.opts.plugins, t.proxy(function(i, o) {
                        ...
                        if (t.isFunction(r[o])) {
                            this[o] = r[o]();
                            for (var s = this.getModuleMethods(this[o]), n = s.length, a = 0; n > a; a++) this[o][s[a]] = this[o][s[a]].bind(this);
        ...
        button: function() {
            return {
                ...
                buildButtonTooltip: function(e, i) {
                    if (!this.opts.air && !this.detect.isMobile()) {
                        var o = t("<span>");
                        o.addClass("re-button-tooltip"), o.html(i), e.append(o), e.on("mouseover", function() {
                            t(this).hasClass("redactor-button-disabled") || (o.show(), o.css("margin-left", -(o.innerWidth() / 2)))
                ...
                build: function(e, i) {
                    if (this.opts.toolbar !== !1) {
                        var o = "undefined" != typeof i.label ? i.label : i.title,
                            r = t('<a href="javascript:void(null);" alt="' + o + '" rel="' + e + '" />');
                        if (r.addClass("re-button re-" + e), r.attr({
                                role: "button",
                                "aria-label": o,
                                tabindex: "-1"
                            }), "undefined" != typeof i.icon) {
                            var s = t("<i>");
                            s.addClass("re-icon-" + e), r.append(s), r.addClass("re-button-icon"), this.button.buildButtonTooltip(r, o)
                        } else r.html(i.title);
                        if ((i.func || i.command || i.dropdown) && this.button.setEvent(r, e, i), i.dropdown) {
                            r.addClass("redactor-toolbar-link-dropdown").attr("aria-haspopup", !0);
                            var n = t('<ul class="redactor-dropdown redactor-dropdown-' + this.uuid + " redactor-dropdown-box-" + e + '" style="display: none;">');
                ...
                setEvent: function(e, i, o) {
                    e.on("mousedown", t.proxy(function(t) {
                        if (t.preventDefault(), e.hasClass("redactor-button-disabled")) return !1;
                        var r = "func",
                            s = o.func;
                ...
                clickCallback: function(e, i, o, r) {
                    var s;
                    if (r = "undefined" == typeof r ? o : r, t.isFunction(i)) i.call(this, o);
                    else if ("-1" !== i.search(/\./)) {
                        if (s = i.split("."), "undefined" == typeof this[s[0]]) return;
                        "object" == typeof r ? this[s[0]][s[1]].apply(this, r) : this[s[0]][s[1]].call(this, r)
                    } else "object" == typeof r ? this[i].apply(this, r) : this[i].call(this, r);
                ...
                setIcon: function(t, e) {
                    t.html(e).addClass("re-button-icon"), this.button.buildButtonTooltip(t, t.attr("alt"))
                },
                changeIcon: function(t, e) {
                    var i = this.button.get(t);
                    0 !== i.length && i.find("i").removeAttr("class").addClass("re-icon-" + e)
                },
            ...
            return {
                ...
                start: function(e) {
                    ...
                    if (e = this.caret.prepare(e)) {
                        if ("BR" === e.tagName) return this.caret.before(e);
                        var r = t(e).children().first(),
                            s = this.utils.isInlineTag(e.tagName);
                        "" === e.innerHTML || s ? this.caret.setStartEmptyOrInline(e, s) : r && 0 !== r.length && this.utils.isInlineTag(r[0].tagName) && "" === r.text() ? this.caret.setStartEmptyOrInline(r[0], !0) : (i = window.getSelection(), i.removeAllRanges(), o = document.createRange(), o.selectNodeContents(e), o.collapse(!0), i.addRange(o))
                    }
                },
                setStartEmptyOrInline: function(e, i) {
                    var o = window.getSelection(),
                        r = document.createRange(),
                        s = document.createTextNode("​");
                    r.setStart(e, 0), r.insertNode(s), r.setStartAfter(s), r.collapse(!0), o.removeAllRanges(), o.addRange(r), i || this.core.editor().on("keydown.redactor-remove-textnode", function() {
                    ...
                    var i, o;
                    if (e = this.caret.prepare(e)) {
                        if ("BR" !== e.tagName && "" === e.innerHTML) return this.caret.start(e);
                        if ("BR" === e.tagName) {
                            var r = document.createElement("span");
                            return r.className = "redactor-invisible-space", r.innerHTML = "&#x200b;", t(e).after(r), i = window.getSelection(), i.removeAllRanges(), o = document.createRange(), o.setStartBefore(r), o.setEndBefore(r), i.addRange(o), void t(r).replaceWith(function() {
                                return t(this).contents()
                            })
                        }
                        if (e.lastChild && 1 === e.lastChild.nodeType) return this.caret.after(e.lastChild);
                ...
                after: function(e) {
                    var i, o;
                    if (e = this.caret.prepare(e)) {
                        if ("BR" === e.tagName) return this.caret.end(e);
                        if (this.utils.isBlockTag(e.tagName)) {
                            var r = this.caret.next(e);
                            return void("undefined" == typeof r ? this.caret.end(e) : ("TABLE" === r.tagName ? r = t(r).find("th, td").first()[0] : "UL" !== r.tagName && "OL" !== r.tagName || (r = t(r).find("li").first()[0]),
                                this.caret.start(r)))
                        }
        ...
        clean: function() {
            return {
                onSet: function(e) {
                    e = this.clean.savePreCode(e), e = this.clean.saveFormTags(e), this.opts.script && (e = e.replace(/<script(.*?[^>]?)>([\w\W]*?)<\/script>/gi, '<pre class="redactor-script-tag" $1>$2</pre>')), e = e.replace(/\$/g, "&#36;"), e = e.replace(/&amp;/g, "&"), e = e.replace(/<a href="(.*?[^>]?)®(.*?[^>]?)">/gi, '<a href="$1&reg$2">'), e = e.replace(/<span id="selection-marker-1"(.*?[^>]?)>​<\/span>/gi, "###marker1###"), e = e.replace(/<span id="selection-marker-2"(.*?[^>]?)>​<\/span>/gi, "###marker2###");
                    var i = this,
                    ...
                    o.find("span, a").attr("data-redactor-span", !0).each(function() {
                        var e = t(this);
                        e.attr("style") && e.attr("data-redactor-style-cache", e.attr("style"))
                    }), e = o.html();
                ...
                onSync: function(e) {
                    if (e = e.replace(/\u200B/g, ""), e = e.replace(/&#x200b;/gi, ""), -1 !== e.search(/^<p>(||\s||<br\s?\/?>||&nbsp;)<\/p>$/i)) return "";
                    e = e.replace(/<span(.*?)id="redactor-image-box"(.*?[^>])>([\w\W]*?)<img(.*?)><\/span>/gi, "$3<img$4>"), e = e.replace(/<span(.*?)id="redactor-image-resizer"(.*?[^>])>(.*?)<\/span>/gi, ""), e = e.replace(/<span(.*?)id="redactor-image-editter"(.*?[^>])>(.*?)<\/span>/gi, ""), e = e.replace(/<img(.*?)style="(.*?)opacity: 0\.5;(.*?)"(.*?)>/gi, '<img$1style="$2$3"$4>');
                    var i = t("<div/>").html(t.parseHTML(e, document, !0));
                    i.find('*[style=""]').removeAttr("style"), i.find('*[class=""]').removeAttr("class"), i.find('*[rel=""]').removeAttr("rel"), i.find(".redactor-invisible-space, .redactor-unlink").each(function() {
                        t(this).contents().unwrap()
                    }), i.find("span, a").removeAttr("data-redactor-span data-redactor-style-cache").each(function() {
                        0 === this.attributes.length && t(this).contents().unwrap()
                    }), i.find("img").removeAttr("rel"), i.find(".redactor-selection-marker, #redactor-insert-marker").remove(), e = i.html(), this.opts.script && (e = e.replace(/<pre class="redactor-script-tag"(.*?[^>]?)>([\w\W]*?)<\/pre>/gi, "<script$1>$2</script>")), e = this.clean.restoreFormTags(e), e = e.replace(new RegExp("<br\\s?/?></h", "gi"), "</h"), e = e.replace(new RegExp("<br\\s?/?></li>", "gi"), "</li>"), e = e.replace(new RegExp("</li><br\\s?/?>", "gi"), "</li>"), e = e.replace(/<pre>/gi, "<pre>\n"), this.opts.preClass && (e = e.replace(/<pre>/gi, '<pre class="' + this.opts.preClass + '">')), this.opts.linkNofollow && (e = e.replace(/<a(.*?)rel="nofollow"(.*?[^>])>/gi, "<a$1$2>"), e = e.replace(/<a(.*?[^>])>/gi, '<a$1 rel="nofollow">'));
                    var o = {
                        "™": "&trade;",
                        "©": "&copy;",
                        "…": "&hellip;",
                    ...
                    }), e = e.replace(/&amp;/g, "&"), e = e.replace(/<p><\/p>/gi, ""), e = e.replace(/\n{2,}/g, "\n"), this.opts.removeNewlines && (e = e.replace(/\r?\n/g, "")), e
                },
                onPaste: function(e, i, o) {
                    if (o !== !0) {
                        e = e.replace(/<b\sid="internal-source-marker(.*?)">([\w\W]*?)<\/b>/gi, "$2"), e = e.replace(/<b(.*?)id="docs-internal-guid(.*?)">([\w\W]*?)<\/b>/gi, "$3"), e = e.replace(/<span[^>]*(font-style: italic; font-weight: bold|font-weight: bold; font-style: italic)[^>]*>([\w\W]*?)<\/span>/gi, "<b><i>$2</i></b>"), e = e.replace(/<span[^>]*(font-style: italic; font-weight: 700|font-weight: 700; font-style: italic)[^>]*>([\w\W]*?)<\/span>/gi, "<b><i>$2</i></b>"), e = e.replace(/<span[^>]*font-style: italic[^>]*>([\w\W]*?)<\/span>/gi, "<i>$1</i>"), e = e.replace(/<span[^>]*font-weight: bold[^>]*>([\w\W]*?)<\/span>/gi, "<b>$1</b>"), e = e.replace(/<span[^>]*font-weight: 700[^>]*>([\w\W]*?)<\/span>/gi, "<b>$1</b>");
                        var r = this.clean.isHtmlMsWord(e);
                        r && (e = this.clean.cleanMsWord(e))
                    }
                    return e = t.trim(e), i.pre ? this.opts.preSpaces && (e = e.replace(/\t/g, new Array(this.opts.preSpaces + 1).join(" "))) : (e = this.clean.replaceBrToNl(e), e = this.clean.removeTagsInsidePre(e)), o !== !0 && (e = this.clean.removeEmptyInlineTags(e), i.encode === !1 && (e = e.replace(/&/g, "&amp;"), e = this.clean.convertTags(e, i), e = this.clean.getPlainText(e), e = this.clean.reconvertTags(e, i))), i.text && (e = this.clean.replaceNbspToSpaces(e), e = this.clean.getPlainText(e)), i.lists && (e = e.replace("\n", "<br>")), i.encode && (e = this.clean.encodeHtml(e)), i.paragraphize && (e = this.paragraphize.load(e)), e
                },
                ...
                removeEmptyInlineTags: function(e) {
                    var i = this.opts.inlineTags,
                        o = t("<div/>").html(t.parseHTML(e, document, !0)),
                        r = this,
                        s = o.find("span"),
                        n = o.find(i.join(","));
                    return n.removeAttr("style"), n.each(function() {
                        var e = t(this).html();
                        0 === this.attributes.length && r.utils.isEmpty(e) && t(this).replaceWith(function() {
                            return t(this).contents()
                        })
                    }), s.each(function() {
                        t(this).html();
                        0 === this.attributes.length && t(this).replaceWith(function() {
                            return t(this).contents()
                        })
                    }), e = o.html(), o.remove(), e
                },
                cleanMsWord: function(e) {
                    e = e.replace(/<!--[\s\S]*?-->/g, ""), e = e.replace(/<o:p>[\s\S]*?<\/o:p>/gi, ""), e = e.replace(/\n/g, " "), e = e.replace(/<br\s?\/?>|<\/p>|<\/div>|<\/li>|<\/td>/gi, "\n\n");
                    var i = t("<div/>").html(e),
                        o = !1,
                        r = 1,
                        s = [];
                    return i.find("p[style]").each(function() {
                        var e = t(this).attr("style").match(/mso\-list\:l([0-9]+)\slevel([0-9]+)/);
                        if (e) {
                            var n = parseInt(e[1]),
                                a = parseInt(e[2]),
                                l = t(this).html().match(/^[\w]+\./) ? "ol" : "ul",
                                c = t("<li/>").html(t(this).html());
                            if (c.html(c.html().replace(/^([\w\.]+)</, "<")), c.find("span:first").remove(), 1 == a && -1 == t.inArray(n, s)) {
                                var d = t("<" + l + "/>").attr({
                                    "data-level": a,
                                    "data-list": n
                                }).html(c);
                                ...
                                if (a > r) {
                                    for (var h = i.find('[data-level="' + r + '"][data-list="' + o + '"]'), u = h, p = r; a > p; p++) d = t("<" + l + "/>"), d.appendTo(u.find("li").last()), u = d;
                                    u.attr({
                                        "data-level": a,
                                        "data-list": n
                                    }).html(c)
                                } else {
                                    var h = i.find('[data-level="' + a + '"][data-list="' + n + '"]').last();
                                    h.append(c)
                                }
                                r = a, o = n, t(this).remove()
                            }
                        }
                    }), i.find("[data-level][data-list]").removeAttr("data-level data-list"), e = i.html()
                },
                ...
                convertTags: function(e, i) {
                    ...
                    var r = o.find("a");
                    if (r.removeAttr("style"), this.opts.pasteLinkTarget !== !1 && r.attr("target", this.opts.pasteLinkTarget), i.links && this.opts.pasteLinks && o.find("a").each(function(t, e) {
                            if (e.href) {
                                for (var i, o = '##%a href="' + e.href + '"', r = 0, s = e.attributes.length; s > r; r++) i = e.attributes.item(r), "href" !== i.name && (o += " " + i.name + '="' + i.value + '"');
                                e.outerHTML = o + "%##" + e.innerHTML + "##%/a%##"
                            }
                        }), e = o.html(), i.images && this.opts.pasteImages && (e = e.replace(/<img(.*?)src="(.*?)"(.*?[^>])>/gi, '##%img$1src="$2"$3%##')), this.opts.pastePlainText) return e;
                    ...
                    for (var a = s.length, l = 0; a > l; l++) e = e.replace(new RegExp("</" + s[l] + ">", "gi"), "###/" + s[l] + "###"), e = "td" === s[l] || "th" === s[l] ? e.replace(new RegExp("<" + s[l] + '(.*?[^>])((colspan|rowspan)="(.*?[^>])")?(.*?[^>])>', "gi"), "###" + s[l] + " $2###") : "span" === s[l] ? e.replace(new RegExp("<" + s[l] + '(.*?[^>])class="(.*?[^>])"(.*?[^>])>', "gi"), "###" + s[l] + ' class="$2"###') : e.replace(new RegExp("<" + s[l] + "[^>]*>", "gi"), "###" + s[l] + "###");
                    return e
                },
                reconvertTags: function(t, e) {
                    if ((e.links && this.opts.pasteLinks || e.images && this.opts.pasteImages) && (t = t.replace(new RegExp("##%", "gi"), "<"), t = t.replace(new RegExp("%##", "gi"), ">")), this.opts.pastePlainText) return t;
                    ...
                    for (var r = i.length, s = 0; r > s; s++) t = t.replace(new RegExp("###/" + i[s] + "###", "gi"), "</" + i[s] + ">");
                    for (var s = 0; r > s; s++) t = t.replace(new RegExp("###" + i[s] + "###", "gi"), "<" + i[s] + ">");
                    for (var s = 0; r > s; s++) "td" !== i[s] && "th" !== i[s] && "span" !== i[s] || (t = t.replace(new RegExp("###" + i[s] + "s?(.*?[^#])###", "gi"), "<" + i[s] + "$1>"));
                    return t
                },
                cleanPre: function(e) {
                ...
                savePreFormatting: function(e) {
                    ...
                    return null === i ? e : (t.each(i, t.proxy(function(t, i) {
                        var o, r, s, n = [],
                            a = !1;
                        i.match(/<pre(.*?)>(([\n\r\s]+)?)<code(.*?)>/i) ? (n = i.match(/<pre(.*?)>(([\n\r\s]+)?)<code(.*?)>([\w\W]*?)<\/code><\/pre>/i), a = !0, o = n[5], r = n[1], s = n[4]) : (n = i.match(/<pre(.*?)>([\w\W]*?)<\/pre>/i), o = n[2], r = n[1]), o = o.replace(/<br\s?\/?>/g, "\n"), o = o.replace(/&nbsp;/g, " "), this.opts.preSpaces && (o = o.replace(/\t/g, new Array(this.opts.preSpaces + 1).join(" "))), o = this.clean.encodeEntities(o), o = o.replace(/\$/g, "&#36;"), e = a ? e.replace(i, "<pre" + r + "><code" + s + ">" + o + "</code></pre>") : e.replace(i, "<pre" + r + ">" + o + "</pre>")
                    }, this)), e)
                },
                saveCodeFormatting: function(e) {
                    ...
                    return null === i ? e : (t.each(i, t.proxy(function(t, i) {
                        ...
                        o[2] = o[2].replace(/&nbsp;/g, " "), o[2] = this.clean.encodeEntities(o[2]), o[2] = o[2].replace(/\$/g, "&#36;"), e = e.replace(i, "<code" + o[1] + ">" + o[2] + "</code>")
                    }, this)), e)
                },
                restoreSelectionMarkers: function(t) {
                    return t = t.replace(/&lt;span id=&quot;selection-marker-([0-9])&quot; class=&quot;redactor-selection-marker&quot;&gt;​&lt;\/span&gt;/g, '<span id="selection-marker-$1" class="redactor-selection-marker">​</span>')
                },
                ...
                encodeHtml: function(t) {
                    return t = t.replace(/”/g, '"'), t = t.replace(/“/g, '"'), t = t.replace(/‘/g, "'"), t = t.replace(/’/g, "'"), t = this.clean.encodeEntities(t)
                },
                encodeEntities: function(t) {
                    return t = String(t).replace(/&amp;/g, "&").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&quot;/g, '"'), t = t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;")
                },
                stripTags: function(t, e) {
                    if ("undefined" == typeof e) return t.replace(/(<([^>]+)>)/gi, "");
        ...
        code: function() {
            return {
                ...
                html: !1,
                start: function(e) {
                    e = t.trim(e), e = e.replace(/^(<span id="selection-marker-1" class="redactor-selection-marker">​<\/span>)/, ""), "textarea" === this.opts.type ? e = this.clean.onSet(e) : "div" === this.opts.type && "" === e && (e = this.opts.emptyHtml), e = e.replace(/<p><span id="selection-marker-1" class="redactor-selection-marker">​<\/span><\/p>/, ""), this.events.stopDetectChanges(), this.core.editor().html(e), this.observe.load(), this.events.startDetectChanges()
                },
                set: function(e, i) {
                    e = t.trim(e), i = i || {}, i.start && (this.start = i.start), "textarea" === this.opts.type ? e = this.clean.onSet(e) : "div" === this.opts.type && "" === e && (e = this.opts.emptyHtml), this.core.editor().html(e), "textarea" === this.opts.type && this.code.sync(), this.placeholder.enable()
                },
                get: function() {
                    if ("textarea" === this.opts.type) return this.core.textarea().val();
                ...
                sync: function() {
                    if (this.code.syncFire) {
                        ...
                        if (!this.code.isSync(i)) return this.code.html = i, "textarea" !== this.opts.type ? (this.core.callback("sync", e), void this.core.callback("change", e)) : void("textarea" === this.opts.type && setTimeout(t.proxy(function() {
        ...
        core: function() {
            return {
                ...
                callback: function(e, i, o) {
                    ...
                    if (s) return s;
                    if ("undefined" == typeof this.opts.callbacks[e]) return "undefined" == typeof o ? i : o;
                ...
                destroy: function() {
                    ...
                    }), this.$element.off("click.redactor-click-to-edit"), this.$element.removeClass("redactor-click-to-edit"), this.core.editor().removeClass("redactor-layer"), this.core.editor().removeAttr("contenteditable");
                    var i = this.code.get();
        ...
        dropdown: function() {
            return {
                ...
                buildItem: function(e, i) {
                    var o = t("<li />");
                    if ("undefined" != typeof i.classname && o.addClass(i.classname), -1 !== e.search(/^divider/i)) return o.addClass("redactor-dropdown-divider"), o;
        ...
        events: function() {
            return {
                ...
                iterateObserver: function(t) {
                    var e = !1;
                    (("textarea" === this.opts.type || "div" === this.opts.type) && !this.detect.isFirefox() && t.target === this.core.editor()[0] || "class" === t.attributeName && t.target === this.core.editor()[0]) && (e = !0), e || (this.observe.load(), this.events.changeHandler())
                },
                ...
                onDropUpload: function(t) {
                    if (t.preventDefault(), t.stopPropagation(), (this.opts.dragImageUpload || this.opts.dragFileUpload) && (null !== this.opts.imageUpload || null !== this.opts.fileUpload)) {
                        ...
                        for (var e = t.dataTransfer.files, i = e.length, o = 0; i > o; o++) this.upload.directUpload(e[o], t)
                    }
                },
                onDrop: function(t) {
        ...
        file: function() {
            return {
                ...
                show: function() {
                    this.modal.load("file", this.lang.get("file"), 700), this.upload.init("#redactor-modal-file-upload", this.opts.fileUpload, this.file.insert), t("#redactor-filename").val(this.selection.get().toString()), this.modal.show()
                },
                insert: function(e, i, o) {
                    if ("undefined" != typeof e.error) return this.modal.close(), void this.core.callback("fileUploadError", e);
        ...
        image: function() {
            return {
                ...
                insert: function(e, i, o) {
                    var r;
                    if ("undefined" != typeof e.error) return this.modal.close(), this.events.dropImage = !1, void this.core.callback("imageUploadError", e, o);
                    if (this.events.dropImage !== !1) return r = t(this.events.dropImage), this.core.callback("imageDelete", r[0].src, r), r.attr("src", e.url), this.events.dropImage = !1, void this.core.callback("imageUpload", r, e);
                    this.placeholder.hide();
                    var s = t("<" + this.opts.imageTag + ">");
                    ...
                    } else this.modal.close(), this.buffer.set(), this.air.collapsed(), l ? t(l).after(s) : this.insert.node(s), this.caret.after(s);
                    this.events.dropImage = !1, this.storage.add({
                        type: a,
                        node: r[0],
                        url: r[0].src,
                        id: n
                    }), null !== i ? this.core.callback("imageUpload", r, e) : this.core.callback("imageInserted", r, e)
                },
                setEditable: function(e) {
                    if (e.on("dragstart", function(t) {
                            t.preventDefault()
                        }), this.opts.imageResizable) {
                        var i = t.proxy(function(i) {
                            this.observe.image = e, this.image.resizer = this.image.loadEditableControls(e), t(document).on("mousedown.redactor-image-resize-hide." + this.uuid, t.proxy(this.image.hideResize, this)), this.image.resizer && this.image.resizer.on("mousedown.redactor touchstart.redactor", t.proxy(function(t) {
                                this.image.setResizable(t, e)
                            }, this))
                        }, this);
                        e.off("mousedown.redactor").on("mousedown.redactor", t.proxy(this.image.hideResize, this)), e.off("click.redactor touchstart.redactor").on("click.redactor touchstart.redactor", i)
                    } else e.off("click.redactor touchstart.redactor").on("click.redactor touchstart.redactor", t.proxy(function(i) {
                ...
                moveResize: function(t) {
                    ...
                    if (!(50 > e || 100 > i)) {
                        var e = Math.round(this.image.resizeHandle.el.width() / this.image.resizeHandle.ratio);
                        this.image.resizeHandle.el.attr({
                            width: i,
                            height: e
                        }), this.image.resizeHandle.el.width(i), this.image.resizeHandle.el.height(e), this.code.sync()
                    }
                },
                stopResize: function() {
                ...
                hideResize: function(e) {
                    if (!e || 0 === t(e.target).closest("#redactor-image-box", this.$editor[0]).length) {
                        if (e && "IMG" == e.target.tagName) {
                            t(e.target)
                        }
                        var i = this.$editor.find("#redactor-image-box");
                        0 !== i.length && (t("#redactor-image-editter").remove(), t("#redactor-image-resizer").remove(), i.find("img").css({
                        ...
                        }), i.css("margin", ""), i.find("img").css("opacity", ""), i.replaceWith(function() {
                            return t(this).contents()
                        }), t(document).off("mousedown.redactor-image-resize-hide." + this.uuid), "undefined" != typeof this.image.resizeHandle && this.image.resizeHandle.el.attr("rel", this.image.resizeHandle.el.attr("style")))
                    }
                },
                loadResizableControls: function(e, i) {
                    if (this.opts.imageResizable && !this.detect.isMobile()) {
                        var o = t('<span id="redactor-image-resizer" data-redactor="verified"></span>');
                        return this.detect.isDesktop() || o.css({
                            width: "15px",
                            height: "15px"
                        }), o.attr("contenteditable", !1), i.append(o), i.append(e), o
                    }
                    return i.append(e), !1
                },
                loadEditableControls: function(e) {
                    var i = t('<span id="redactor-image-box" data-redactor="verified">');
                    if (i.css("float", e.css("float")).attr("contenteditable", !1), "auto" != e[0].style.margin ? (i.css({
                            ...
                            display: "block",
                            margin: "auto"
                        }), e.css("opacity", ".5").after(i), this.opts.imageEditable) {
                        this.image.editter = t('<span id="redactor-image-editter" data-redactor="verified">' + this.lang.get("edit") + "</span>"), this.image.editter.attr("contenteditable", !1), this.image.editter.on("click", t.proxy(function() {
                            this.image.showEdit(e)
                        }, this)), i.append(this.image.editter);
                        var o = this.image.editter.innerWidth();
                ...
                showEdit: function(e) {
                    if (!this.events.imageEditing) {
                        ...
                        var i = e.closest("a", this.$editor[0]),
                            o = e.closest("figure", this.$editor[0]),
                            r = 0 !== o.length ? o : e;
                        if (this.modal.load("image-edit", this.lang.get("edit"), 705), this.image.buttonDelete = this.modal.getDeleteButton().text(this.lang.get("delete")), this.image.buttonSave = this.modal.getActionButton().text(this.lang.get("save")), this.image.buttonDelete.on("click", t.proxy(this.image.remove, this)), this.image.buttonSave.on("click", t.proxy(this.image.update, this)), this.opts.imageCaption === !1) t("#redactor-image-caption").val("").hide().prev().hide();
                        else {
                            var s = e.closest(this.opts.imageTag, this.$editor[0]),
                                n = s.find("figcaption");
                            0 !== n && t("#redactor-image-caption").val(n.text()).show()
                        }
                        if (this.opts.imagePosition) {
                            var a = 0 !== o.length ? "center" === r.css("text-align") : "block" == r.css("display") && "none" == r.css("float"),
                                l = a ? "center" : r.css("float");
                        ...
                        var c = t("#redactor-image-link");
                        c.attr("href", e.attr("src")), 0 !== i.length && (c.val(i.attr("href")), "_blank" === i.attr("target") && t("#redactor-image-link-blank").prop("checked", !0)), t(".redactor-link-tooltip").remove(), this.modal.show(), this.detect.isDesktop() && t("#redactor-image-title").focus()
                    }
                },
                update: function() {
                    ...
                    if ("" !== r) {
                        ...
                        if (0 === i.length) {
                            var c = t('<a href="' + r + '" id="redactor-img-tmp">' + this.utils.getOuterHtml(e) + "</a>");
                            l && c.attr("target", "_blank"), e = e.replaceWith(c), i = this.core.editor().find("#redactor-img-tmp"), i.removeAttr("id")
                        } else i.attr("href", r), l ? i.attr("target", "_blank") : i.removeAttr("target")
                    } else 0 !== i.length && i.replaceWith(this.utils.getOuterHtml(e));
                    this.image.addCaption(e, i), this.modal.close(), this.buffer.set()
                },
                setFloating: function(e) {
                    var i = e.closest("figure", this.$editor[0]),
                        o = 0 !== i.length ? i : e,
                        r = t("#redactor-image-align").val(),
                        s = "",
                        n = "",
                        a = "",
                        l = "";
                    switch (r) {
                        case "left":
                            s = "left", a = "0 " + this.opts.imageFloatMargin + " " + this.opts.imageFloatMargin + " 0";
                            break;
                        case "right":
                            s = "right", a = "0 0 " + this.opts.imageFloatMargin + " " + this.opts.imageFloatMargin;
                            break;
                        case "center":
                            0 !== i.length ? l = "center" : (n = "block", a = "auto")
                    }
                    o.css({
                        "float": s,
                        display: n,
                ...
                addCaption: function(e, i) {
                    var o = t("#redactor-image-caption").val(),
                        r = 0 !== i.length ? i : e,
                        s = r.next();
                    0 !== s.length && "FIGCAPTION" === s[0].tagName || (s = !1), "" !== o ? s === !1 ? (s = t("<figcaption />").text(o), r.after(s)) : s.text(o) : s !== !1 && s.remove()
                },
                remove: function(e, i, o) {
                    ...
                    var r = i.closest("a", this.core.editor()[0]),
                        s = i.closest(this.opts.imageTag, this.core.editor()[0]),
                        n = i.parent(),
                        a = this.core.callback("imageDelete", e, i[0]);
                    if (a === !1) return e.preventDefault(), !1;
                    0 !== t("#redactor-image-box").length && (n = t("#redactor-image-box").parent());
                    var l, c;
                    0 !== s.length ? (c = s.prev(), l = s.next(), s.remove()) : 0 !== r.length ? (n = r.parent(), r.remove()) : i.remove(), t("#redactor-image-box").remove(), e !== !1 && (l && 0 !== l.length ? this.caret.start(l) : c && 0 !== c.length && this.caret.end(c)), "boolean" != typeof e && this.modal.close(), this.utils.restoreScroll(), this.observe.image = !1, this.events.startDetectChanges(), this.placeholder.enable(), this.code.sync()
                }
            }
        },
        indent: function() {
            return {
                increase: function() {
                    if (this.list.get()) {
                        var e = t(this.selection.current()).closest("li"),
                            i = e.closest("ul, ol", this.core.editor()[0]),
                            o = e.closest("li"),
                            r = o.prev();
                        if (0 !== r.length && "LI" === r[0].tagName)
                            if (this.buffer.set(), this.utils.isCollapsed()) {
                                var s = i[0].tagName,
                                    n = t("<" + s + " />");
                                this.selection.save();
                                var a = r.find("ol").first();
                                if (1 === a.length) a.append(e);
                                else {
                                    var s = i[0].tagName,
                                        n = t("<" + s + " />");
                            ...
                            } else document.execCommand("indent"), this.selection.save(), this.indent.removeEmpty(), this.indent.normalize(), this.selection.restore()
                    }
                },
                decrease: function() {
                    if (this.list.get()) {
                ...
                repositionItem: function(t) {
                    var e = t.next();
                    0 === e.length || "UL" === e[0].tagName && "OL" === e[0].tagName || t.append(e);
                    var i = t.prev();
                    if (0 !== i.length && "LI" !== i[0].tagName) {
                        this.selection.save();
                        var o = t.parents("li", this.core.editor()[0]);
                ...
                normalize: function() {
                    this.core.editor().find("li").each(t.proxy(function(e, i) {
                        ...
                        var r = o.parent();
                        if (0 !== r.length && "LI" === r[0].tagName) return void r.after(o);
                        var s = o.next();
        ...
        inline: function() {
            return {
                getClearedNodes: function() {
                    for (var e = this.selection.nodes(), i = [], o = e.length, r = 0, s = 0; o > s; s++)
                        if (t(e[s]).hasClass("redactor-selection-marker")) {
                            r = s + 2;
                            break
                        }
                    for (var s = 0; o > s; s++) s >= r && !this.utils.isBlockTag(e[s].tagName) && i.push(e[s]);
                    return i
                },
                isConvertableAttr: function(e, i, o) {
                    var r = t(e).attr(i);
                    if (r)
                        if ("style" === i) {
                            o = t.trim(o).replace(/;$/, "");
                ...
                isConvertable: function(t, e, i, o) {
                    if (e === i) {
                        if (!o) return !0;
                        var r = 0;
                        for (var s in o) r += this.inline.isConvertableAttr(t, s, o[s]);
                        if (r === Object.keys(o).length) return !0
                    }
                    return !1
                },
                setNodesStriked: function(e, i, o) {
                    for (var r = 0; r < e.length; r++) {
                        var s = e[r].tagName ? e[r].tagName.toLowerCase() : void 0,
                            n = e[r].parentNode,
                            a = n && n.tagName ? n.tagName.toLowerCase() : void 0,
                            l = this.inline.isConvertable(n, a, i, o);
                        if (l) {
                        ...
                        if (l) var c = t(e[r]).replaceWith(function() {
                            return t("<strike>").append(t(this).contents())
                        })
                    }
                },
                format: function(t, e, i, o) {
                    ...
                    if (t = t.toLowerCase(), !this.utils.isCurrentOrParent(["PRE", "CODE"])) {
                        for (var s = ["b", "bold", "i", "italic", "underline", "strikethrough", "deleted", "superscript", "subscript"], n = ["strong", "strong", "em", "em", "u", "del", "del", "sup", "sub"], a = 0; a < s.length; a++) t === s[a] && (t = n[a]);
                ...
                formatUncollapsed: function(t, e, i, o) {
                    this.selection.save();
                    var r = this.inline.getClearedNodes();
                    this.inline.setNodesStriked(r, t, e), this.selection.restore(), document.execCommand("strikethrough"), this.selection.saveInstant();
                    var s = this;
                    this.core.editor().find("strike").each(function() {
                        var i = s.utils.replaceToTag(this, t);
                ...
                formatCollapsed: function(e, i, o, r) {
                    ...
                    if (s) {
                        ...
                        if (n === e)
                            if (this.utils.isEmpty(s.innerHTML)) this.caret.after(s), t(s).remove();
                            else {
                                var a = this.inline.insertBreakpoint(s, n);
                                this.caret.after(a)
                            }
                        else 0 === t(s).closest(e).length ? this.inline.insertInline(e, i, o, r) : this.caret.start(s)
                ...
                insertBreakpoint: function(e, i) {
                    ...
                    var r = this.utils.isEndOfElement(e),
                        ...
                        n = r ? "" : "<" + i + ">";
                    s = s.replace(/<span\sid="redactor-inline-breakpoint">​<\/span>/i, "</" + i + ">" + n);
                    var a = t(s);
                ...
                setAttr: function(e, i, o, r) {
                    if ("undefined" == typeof i) return e;
                    var s = "undefined" == typeof r ? "toggle" : r;
                    return "class" === i ? e = this.inline[s + "Class"](o, e) : "remove" === s ? e = this.inline[s + "Attr"](i, e) : "removeAll" === s ? e = this.inline[s + "Attr"](e) : (e = this.inline[s + "Attr"](i, o, e), "style" === i && "SPAN" === e[0].tagName && t(e).attr("data-redactor-span", !0)), e
                },
                ...
                update: function(e, i, o, r) {
                    ...
                    return t.each(s, function(s, l) {
                        if (t.isArray(e)) {
                            if (-1 === t.inArray(l.tagName.toLowerCase(), e)) return
                ...
                removeSpecificAttr: function(e, i, o) {
                    if ("style" === i) {
                        var r = o.split(":"),
                            s = r[0].trim();
                ...
                removeStyleRule: function(e) {
                    ...
                    var i = this.selection.parent(),
                        o = this.selection.inlines();
                    if (this.selection.save(), i && "SPAN" === i.tagName) {
                        var r = t(i);
                        r.css(e, ""), r.removeAttr("data-redactor-span"), this.utils.removeEmptyAttr(r, "style"), 0 === r[0].attributes.length && r.replaceWith(r.contents())
                    }
                    t.each(o, t.proxy(function(i, o) {
                        var r = t(o); - 1 == t.inArray(o.tagName.toLowerCase(), this.opts.inlineTags) || r.hasClass("redactor-selection-marker") || (r.css(e, ""), this.utils.removeEmptyAttr(r, "style"), 0 === r[0].attributes.length && r.replaceWith(r.contents()))
                    }, this)), this.selection.restore()
                }
            }
        },
        insert: function() {
            return {
                ...
                html: function(e, i) {
                    ...
                    if (n.deleteContents(), this.selection.update(s, n), i.lists) {
                        var a = t(e);
                        if (0 !== a.length && ("UL" === a[0].tagName || "OL" === a[0].tagName)) return void this.insert.appendLists(o, a)
                    }
                    if (i.blocks && o)
                        if (this.utils.isSelectAll()) this.core.editor().html(e), this.focus.end();
                        else {
                            var l = this.utils.breakBlockTag();
                            if (l === !1) this.insert.placeHtml(e);
                            else {
                                var c = t(e).children().last();
                                c.append(this.marker.get()), "start" === l.type ? l.$block.before(e) : l.$block.after(e), this.selection.restore(), this.core.editor().find("p").each(function() {
                        ...
                        if (this.utils.isSelectAll()) {
                            var h = t(this.opts.emptyHtml);
                            this.core.editor().html("").append(h), h.html(e), this.caret.end(h)
                ...
                raw: function(t) {
                    ...
                    o.innerHTML = t;
                    for (var r, s, n = document.createDocumentFragment(); r = o.firstChild;) s = n.appendChild(r);
                ...
                node: function(e, i) {
                    ...
                    var o = this.selection.block(),
                        ...
                        s = !0;
                    if (this.utils.isSelectAll()) r ? this.core.editor().html(e) : this.core.editor().html(t("<p>").html(e)), this.code.sync();
                    else if (r && o) {
                        var n = this.utils.breakBlockTag();
                        n === !1 ? this.insert.placeNode(e, i) : ("start" === n.type ? n.$block.before(e) : n.$block.after(e), this.core.editor().find("p:empty").remove())
                ...
                appendLists: function(e, i) {
                    ...
                    if (s || this.utils.isEndOfElement(e)) o = r, i.find("li").each(function() {
                        o.after(this), o = t(this)
                    }), s && r.remove();
                    else if (this.utils.isStartOfElement(e)) i.find("li").each(function() {
                ...
                placeNode: function(t, e) {
                    var i = this.selection.get(),
                        o = this.selection.range(i);
                    return null == o ? !1 : (e !== !1 && o.deleteContents(), o.insertNode(t), o.collapse(!1), void this.selection.update(i, o))
                },
                nodeToPoint: function(e, i) {
                    if (this.placeholder.hide(), i = i[0] || i, this.utils.isEmpty()) return i = this.utils.isBlock(i) ? i : t("<p />").append(i), this.core.editor().html(i), i;
                    var o, r = e.clientX,
                        s = e.clientY;
                    ...
                    } else if (document.caretRangeFromPoint) o = document.caretRangeFromPoint(r, s), o.insertNode(i);
            ...
            return {
                init: function(e) {
                    if (!this.rtePaste) {
                        ...
                        if (this.shortcuts.init(e, i), this.keydown.checkEvents(o, i), this.keydown.setupBuffer(e, i), this.utils.isSelectAll() && (i === this.keyCode.ENTER || i === this.keyCode.BACKSPACE || i === this.keyCode.DELETE)) return e.preventDefault(), void this.code.set(this.opts.emptyHtml);
                        ...
                        if (i === this.keyCode.ENTER && (e.ctrlKey || e.shiftKey)) return e.preventDefault(), this.keydown.onShiftEnter(e);
                        if (i === this.keyCode.ENTER && !e.shiftKey && !e.ctrlKey && !e.metaKey) return this.keydown.onEnter(e);
                        ...
                        if (i === this.keyCode.BACKSPACE || i === this.keyCode.DELETE) {
                            if (this.observe.image && "undefined" != typeof this.observe.image) {
                                e.preventDefault();
                                var a = this.observe.image.closest("figure, p").prev();
                                return this.image.remove(!1), this.observe.image = !1, void(a && 0 !== a.length ? this.caret.end(a) : this.core.editor().focus())
                            }
                            this.keydown.onBackspaceAndDeleteBefore()
                        }
                        if (i === this.keyCode.DELETE) {
                            var l = t(this.keydown.block).next();
                            if (this.utils.isEndOfElement(this.keydown.block) && 0 !== l.length && "FIGURE" === l[0].tagName) return l.remove(), !1;
                            var c = this.keydown.block && "LI" === this.keydown.block.tagName ? this.keydown.block : !1;
                            if (c) {
                                var d = t(this.keydown.block).parents("ul, ol").last(),
                                    h = d.next();
                                if (this.utils.isRedactorParent(d) && this.utils.isEndOfElement(d) && 0 !== h.length && ("UL" === h[0].tagName || "OL" === h[0].tagName)) return e.preventDefault(), d.append(h.contents()), h.remove(), !1
                            }
                            if (this.utils.isEndOfElement(this.keydown.block) && 0 !== l.length && "PRE" === l[0].tagName) return t(this.keydown.block).append(l.text()), l.remove(), !1
                        }
                        if (i === this.keyCode.DELETE && 0 !== t("#redactor-image-box").length && this.image.remove(), i === this.keyCode.BACKSPACE) {
                            if (this.detect.isFirefox() && this.line.removeOnBackspace(e), this.list.combineAfterAndBefore(this.keydown.block)) return void e.preventDefault();
                            var u = this.selection.block();
                            if (u && "LI" === u.tagName && this.utils.isCollapsed() && this.utils.isStartOfElement()) return this.indent.decrease(), void e.preventDefault();
                ...
                onBackspaceAndDeleteAfter: function(e) {
                    setTimeout(t.proxy(function() {
                        this.code.syncFire = !1, this.keydown.removeEmptyLists(), this.core.editor().find("*[style]").not("img, #redactor-image-box, #redactor-image-editter, [data-redactor-span]").removeAttr("style"), this.keydown.formatEmpty(e), this.code.syncFire = !0
                    }, this), 1)
                },
                onEnter: function(e) {
                    ...
                    if (this.keydown.blockquote || this.keydown.figcaption) return this.keydown.insertBreakLine(e);
                    if (this.keydown.figure) setTimeout(t.proxy(function() {
                    ...
                    } else if (!this.keydown.block) return this.keydown.insertParagraph(e);
                    return this.detect.isFirefox() && this.utils.isInline(this.keydown.parent) ? void this.keydown.insertBreakLine(e) : void setTimeout(t.proxy(function() {
                ...
                insertAfterLastElement: function(e) {
                    if (this.utils.isEndOfElement(e)) {
                        ...
                        if (0 === o.length) {
                            if (0 === i.length && i[0] !== e) return void this.caret.start(i);
                            var r = t(this.opts.emptyHtml);
                ...
                replaceToParagraph: function(e) {
                    var i = this.selection.block(),
                        o = t(i).prev(),
                        r = i.innerHTML.replace(/<br\s?\/?>/gi, "");
                    if (i.tagName === e && this.utils.isEmpty(r) && !t(i).hasClass("redactor-in")) {
                        var s = document.createElement("p");
                        return t(i).replaceWith(s), this.keydown.setCaretToParagraph(s), !1
                    }
                    if ("P" === i.tagName) return t(i).removeAttr("class").removeAttr("style"), this.detect.isIe() && this.utils.isEmpty(r) && this.utils.isInline(this.keydown.parent) && t(i).on("input", t.proxy(function() {
                        var e = this.selection.parent();
                ...
                setCaretToParagraph: function(t) {
                ...
                formatEmpty: function(e) {
                    ...
                    if (this.utils.isEmpty(i)) return e.preventDefault(), "inline" === this.opts.type || "pre" === this.opts.type ? (this.core.editor().html(this.marker.html()), this.selection.restore()) : (this.core.editor().html(this.opts.emptyHtml), this.focus.start()), !1
                }
            }
        },
        keyup: function() {
                ...
                removeOnBackspace: function(e) {
                    if (this.utils.isCollapsed()) {
                        ...
                        if (0 !== i.length && this.utils.isStartOfElement(i)) {
                            var o = i.prev();
                            o && 0 !== o.length && "HR" === o[0].tagName && (e.preventDefault(), o.remove())
                        }
                    }
                }
            }
        ...
        link: function() {
            return {
                ...
                insert: function(e, i) {
                    var o = this.link.is();
                    if (i !== !0 && (e = this.link.buildLinkFromObject(o, e), e === !1)) return !1;
                    if (this.buffer.set(), e = this.core.callback("beforeInsertingLink", e), o === !1) {
                ...
                show: function(e) {
                    ...
                    o.url = this.link.removeSelfHostFromUrl(o.url), this.opts.linkNewTab && !i && (o.target = !0), this.link.setModalValues(o), this.modal.show(), this.detect.isDesktop() && t("#redactor-link-url").focus()
                },
                ...
                isUrl: function(t) {
                    var e = "((xn--)?[\\W\\w\\D\\d]+(-[\\W\\w\\D\\d]+)*\\.)+[\\W\\w]{2,}",
                        ...
                        s = new RegExp("^/", "i"),
                        n = new RegExp("^tel:(.*?)", "i");
                    return -1 === t.search(i) && -1 !== t.search(o) && -1 === t.search(r) && "/" !== t.substring(0, 1) && (t = "http://" + t), -1 !== t.search(i) || -1 !== t.search(r) || -1 !== t.search(s) || -1 !== t.search(n) ? t : !1
                },
                isMailto: function(t) {
            ...
            return {
                ...
                format: function() {
                    if (this.opts.linkify && !this.utils.isCurrentOrParent("pre")) {
                        this.core.editor().find(":not(iframe,img,a,pre,code,.redactor-unlink)").addBack().contents().filter(t.proxy(this.linkify.isFiltered, this)).each(t.proxy(this.linkify.handler, this));
            ...
            return {
                toggle: function(e) {
                    if (!this.utils.inBlocks(["table", "td", "th", "tr"])) {
                        ...
                        if (this.placeholder.hide(), this.buffer.set(), 0 !== o.length && o[0].tagName === i && this.utils.isRedactorParent(o)) return this.selection.save(), o.find("ul, ol").each(function() {
                        ...
                        var r = this.list.get();
                        if (!r) return void(this.selection.block() || document.execCommand("formatblock", !1, "p"));
                ...
                combineAfterAndBefore: function(e) {
                    var i = t(e).prev(),
                        ...
                        s = 1 === i.closest("ol, ul", this.core.editor()[0]).length && 1 === o.closest("ol, ul", this.core.editor()[0]).length;
        ...
        modal: function() {
            return {
                ...
                close: function(e) {
                    if (e) {
                        if ("redactor-modal-button-cancel" !== t(e.target).attr("id") && e.target !== this.$modalClose[0] && e.target !== this.$modalBox[0]) return;
                        e.preventDefault()
                    }
        ...
        observe: function() {
            return {
                ...
                images: function() {
                    this.opts.imageEditable && (this.core.editor().addClass("redactor-layer-img-edit"), this.core.editor().find("img").each(t.proxy(function(e, i) {
                        var o = t(i);
        ...
        offset: function() {
            return {
                ...
                clone: function(t) {
                    var e = this.selection.get(),
                        i = this.selection.range(e);
                    if (null === i && "undefined" == typeof t) return !1;
                    if (t = "undefined" == typeof t ? this.$editor : t, t === !1) return !1;
                    t = t[0] || t;
                    var o = i.cloneRange();
        ...
        paragraphize: function() {
            return {
                ...
                getSafes: function(e) {
                    ...
                    }, this)), i.find("span.redactor-selection-marker").each(t.proxy(function(e, i) {
                        return this.paragraphize.z++, this.paragraphize.safes[this.paragraphize.z] = i.outerHTML, t(i).replaceWith("\n#####replace" + this.paragraphize.z + "#####\n\n")
                    }, this)), i.html()
                },
                restoreSafes: function(e) {
                    return t.each(this.paragraphize.safes, function(t, i) {
                        i = "undefined" != typeof i ? i.replace(/\$/g, "&#36;") : i, e = e.replace("#####replace" + t + "#####", i)
                    }), e
                },
                convert: function(e) {
        ...
        paste: function() {
            return {
                init: function(e) {
                    ...
                    return this.detect.isDesktop() && !this.paste.pre && this.opts.clipboardImageUpload && this.opts.imageUpload && this.paste.detectClipboardUpload(e) ? void(this.detect.isIe() && setTimeout(t.proxy(this.paste.clipboardUpload, this), 100)) : (this.utils.saveScroll(), this.selection.save(), this.paste.createPasteBox(i), t(window).on("scroll.redactor-freeze", t.proxy(function() {
                ...
                appendPasteBox: function() {
                    if (this.detect.isIe()) this.core.box().append(this.$pasteBox);
                        ...
                        e.length > 0 ? e.append(this.$pasteBox) : t("body").prepend(this.$pasteBox)
                    }
                },
                detectClipboardUpload: function(e) {
                    ...
                    var o = i.types;
                    if (-1 !== o.indexOf("public.tiff")) return e.preventDefault(), !1;
                        ...
                        if (-1 !== i.src.search(/^data\:image/i)) {
                            ...
                            if (window.FormData) {
                                this.buffer.set(), this.upload.direct = !0, this.upload.type = "image", this.upload.url = this.opts.imageUpload, this.upload.callback = t.proxy(function(e) {
                                    ...
                                    i.src = e.url, this.core.callback("imageUpload", t(i), e)
                                }, this);
            ...
            return {
                ...
                block: function(e) {
                    for (e = e || this.selection.current(); e;) {
                        if (this.utils.isBlockTag(e.tagName)) return t(e).hasClass("redactor-in") ? !1 : e;
                        e = e.parentNode
                    }
                    return !1
                },
                inline: function(e) {
                    for (e = e || this.selection.current(); e;) {
                        if (this.utils.isInlineTag(e.tagName)) return t(e).hasClass("redactor-in") ? !1 : e;
                        e = e.parentNode
                    }
                    return !1
                },
                element: function(e) {
                    for (e || (e = this.selection.current()); e;) {
                        if (1 === e.nodeType) return t(e).hasClass("redactor-in") ? !1 : e;
                        e = e.parentNode
                    }
                    return !1
                },
                ...
                nodes: function(e) {
                    ...
                    for (var a = []; s && s !== n;) a.push(s = this.selection.nextNode(s));
                    for (s = r.startContainer; s && s !== r.commonAncestorContainer;) a.unshift(s), s = s.parentNode;
                    var l = [];
                    return t.each(a, function(e, o) {
                        if (o) {
                            var r = 1 !== o.nodeType ? !1 : o.tagName.toLowerCase();
                            if (t(o).hasClass("redactor-script-tag, redactor-selection-marker")) return;
                            if (r && 0 !== i.length && -1 === t.inArray(r, i)) return;
                            l.push(o)
                        }
                    }), 0 === l.length ? [] : l
                },
                ...
                restoreInstant: function(t) {
                    if ("undefined" != typeof t || this.saved) {
                        this.saved = "undefined" != typeof t ? t : this.saved;
                        var e = this.core.editor().find(this.saved.node);
                        if (0 === e.length || 0 !== e.text().trim().replace(/\u200B/g, "").length) {
                            var i = this.core.editor()[0],
                                o = i.ownerDocument,
                                r = o.defaultView,
                                s = 0,
                                n = o.createRange();
                            ...
                            for (var a, l = [i], c = !1, d = !1; !d && (a = l.pop());)
                                if (3 == a.nodeType) {
                                    var h = s + a.length;
                                    !c && this.saved.start >= s && this.saved.start <= h && (n.setStart(a, this.saved.start - s), c = !0), c && this.saved.end >= s && this.saved.end <= h && (n.setEnd(a, this.saved.end - s), d = !0), s = h
                                } else
                                    for (var u = a.childNodes.length; u--;) l.push(a.childNodes[u]);
                ...
                html: function() {
                    ...
                    if (e.rangeCount) {
                        for (var i = document.createElement("div"), o = e.rangeCount, r = 0; o > r; ++r) i.appendChild(e.getRangeAt(r).cloneContents());
            ...
            return {
                ...
                build: function(e, i, o) {
                    for (var r = t.proxy(function() {
                        ...
                        }, this), s = i.split(","), n = s.length, a = 0; n > a; a++) "string" == typeof s[a] && this.shortcuts.handler(e, t.trim(s[a]), r)
                },
            ...
            return {
                ...
                setFixed: function() {
                    if (this.opts.toolbarFixed && !this.opts.toolbarExternal) {
                        ...
                        setTimeout(t.proxy(function() {
                            if (this.toolbar.observeScroll(!1), this.detect.isDesktop()) t(this.opts.toolbarFixedTarget).on("scroll.redactor." + this.uuid, t.proxy(this.toolbar.observeScroll, this));
                            else {
                                var e = this;
                ...
                observeScrollEnable: function(e, i) {
                    if ("undefined" != typeof this.fullscreen && this.fullscreen.isOpened === !1) return void this.toolbar.observeScrollDisable();
                    var o = i + this.core.box().outerHeight() - 32,
                        r = this.core.box().innerWidth(),
                        s = this.detect.isDesktop() ? "fixed" : "absolute",
                        n = this.detect.isDesktop() ? this.opts.toolbarFixedTopOffset : t(this.opts.toolbarFixedTarget).scrollTop() - i + this.opts.toolbarFixedTopOffset,
            ...
            return {
                ...
                onDrop: function(t) {
                    ...
                    if (this.opts.multipleImageUpload)
                        for (var i = e.length, o = 0; i > o; o++) this.upload.traverseFile(e[o], t);
                    else this.upload.traverseFile(e[0], t)
                },
                traverseFile: function(t, e) {
                    if (this.opts.s3) return this.upload.setConfig(t), void this.uploads3.send(t, e);
                ...
                send: function(e, i) {
                    ...
                    o.open("POST", this.upload.url), o.setRequestHeader("X-Requested-With", "XMLHttpRequest"), o.onreadystatechange = t.proxy(function() {
                        if (4 === o.readyState) {
                            ...
                            this.progress.hide(), this.upload.direct || this.upload.$droparea.removeClass("drag-drop"), this.upload.callback(e, this.upload.direct, i)
                        }
                    }, this), o.send(e)
                },
                onDrag: function(t) {
            ...
            return {
                ...
                sendToS3: function(e, i, o) {
                    ...
                    r && (r.onload = t.proxy(function() {
                        var t;
                        if (this.progress.hide(), 200 !== r.status) return t = {
                            error: !0
        ...
        utils: function() {
            return {
                ...
                dataURItoBlob: function(t) {
                    ...
                    for (var i = t.split(",")[0].split(":")[1].split(";")[0], o = new Uint8Array(e.length), r = 0; r < e.length; r++) o[r] = e.charCodeAt(r);
                    return new Blob([o], {
                        type: i
                    })
                },
                ...
                breakBlockTag: function() {
                    ...
                    if ("pre" === o || "li" === o || "td" === o || "th" === o) return !1;
                    if (!i && this.utils.isStartOfElement(e)) return {
                        $block: t(e),
                        $next: t(e).next(),
                        type: "start"
                    };
                    if (!i && this.utils.isEndOfElement(e)) return {
                        $block: t(e),
                        $next: t(e).next(),
                        type: "end"
                    };
                ...
                getScrollTarget: function() {
                    var e = t(this.opts.scrollTarget);
                    return 0 !== e.length ? e : t(document)
                },
                freezeScroll: function() {
                    this.freezeScrollTop = this.utils.getScrollTarget().scrollTop(), this.utils.getScrollTarget().scrollTop(this.freezeScrollTop)
                },
                unfreezeScroll: function() {
                    "undefined" != typeof this.freezeScrollTop && this.utils.getScrollTarget().scrollTop(this.freezeScrollTop)
                },
                saveScroll: function() {
                    this.tmpScrollTop = this.utils.getScrollTarget().scrollTop()
                },
                restoreScroll: function() {
                    "undefined" != typeof this.tmpScrollTop && this.utils.getScrollTarget().scrollTop(this.tmpScrollTop)
                },
                ...
                isEndOfElement: function(e) {
                    if ("undefined" == typeof e && (e = this.selection.block(), !e)) return !1;
                ...
                replaceToTag: function(e, i) {
                    ...
                    return t(e).replaceWith(function() {
                        ...
                        for (var e = 0; e < this.attributes.length; e++) o.attr(this.attributes[e].name, this.attributes[e].value);
                        return o
                    }), o
                },
                ...
                appendFields: function(e, i) {
                    if (!e) return i;
                    if ("object" == typeof e) return t.each(e, function(e, o) {
                        null !== o && 0 === o.toString().indexOf("#") && (o = t(o).val()), i.append(e, o)
                    }), i;
                    var o = t(e);
...
function(t) {
    ...
    t.fn.redactorAnimation = function(t, i, o) {
        ...
        animate: function(e) {
            this.$element.addClass("redactor-animated").css("display", "").removeClass("hide"), this.$element.addClass(this.opts.prefix + this.queue[0]), this.set(this.opts.duration + "s", this.opts.delay + "s", this.opts.iterate, this.opts.timing);
        ...
        set: function(t, e, i, o) {
            for (var r = this.prefixes.length; r--;) this.$element.css(this.prefixes[r] + "animation-duration", t), this.$element.css(this.prefixes[r] + "animation-delay", e), this.$element.css(this.prefixes[r] + "animation-iteration-count", i), this.$element.css(this.prefixes[r] + "animation-timing-function", o)
        },
        clean: function() {
            this.$element.removeClass("redactor-animated"), this.$element.removeClass(this.opts.prefix + this.queue[0]), this.set("", "", "", "")
        },
